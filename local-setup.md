...
| LFM2.5-2.6B | Hybrid edge (conv + 8 GQA), 128K train ctx (✅ Jetson tested; ⚠️ RTX 3090 WSL2 untested @ 128k) | [LiquidAI/LFM2.5-2.6B-GGUF](https://huggingface.co/LiquidAI/LFM2.5-2.6B-GGUF/tree/main) | [LiquidAI/LFM2.5-2.6B](https://huggingface.co/LiquidAI/LFM2.5-2.6B) |
...
# LFM2.5 example (Jetson / RTX 3090 guides; official Liquid GGUF)
...
- **LFM2.5-2.6B + agents (Pi):** omit server `--reasoning off` — the template always opens `<think>`. Official sampling **temp 0.1 / top_k 50 / repeat-penalty 1.1**. Pi **skills/tools:** `reasoning` false, no `thinkingLevelMap`. Pi **traces:** `reasoning` true, `thinkingLevelMap.off` null. Jetson ✅ **Q8_0 @ 64k / 8192**; 3090 WSL2 ⚠️ **Q8_0 @ 128k / 16384 / FA off** (not the 4090 cmake). See [Jetson LFM2.5](Jetson-Orin-Nano-Super/Jetson-Orin-LFM2.5-2.6B.md) · [RTX 3090 LFM2.5](Win-RTX3090-24GB/Windows-RTX3090-LFM2.5-2.6B.md) and [agentic harnesses — LFM2.5](agentic-harnesses.md#lfm25-26b--pi-coding-agent).
