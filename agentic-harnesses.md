...
| **`--ctx-size` / `contextWindow` 65536** on 8 GB (stretch **131072**, FA **on**); **131072 / FA on** on 24 GB Ampere WSL; **131072 / FA on** on DGX Spark GB10 | Gemma’s 16k window (Pi first-turn `length`; [guide](Jetson-Orin-Nano-Super/Jetson-Orin-LFM2.5-2.6B.md#pi-truncation-on-the-first-turn)); 4090 `FA_ALL_QUANTS` cmake; copying the 3090 `86-real` cmake onto Spark |
