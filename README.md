...
[Ternary Bonsai 2 27B](https://huggingface.co/prism-ml/Ternary-Bonsai-2-27B-gguf) is PrismML’s ternary (`{−1,0,+1}`) pack of **Qwen3.8-27B** (~5.9 GB `PTQ1_0` / ~7.2 GB `PQ2_0`, Apache 2.0, 262k). **Stock llama.cpp and llama-cpp-turboquant refuse these files.** Need [PrismML-Eng/llama.cpp](https://github.com/PrismML-Eng/llama.cpp) (`prism` branch, **prism-b10658+**). Guides download **both** packs; PRIMARY is `PQ2_0` (7900 XTX: **HIP**, not that folder’s usual Vulkan). Dual RTX and DGX Spark pin **262k**; 24 GB boxes start at **131k**.
...
**Last Updated:** 2026-09-18 (DGX Spark Ternary Bonsai 2)  
